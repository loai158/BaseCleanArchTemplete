        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Retailers_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Retailers_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Retailers_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SupplierReview_Rating", "[Rating] BETWEEN 1 AND 5");
                    table.ForeignKey(
                        name: "FK_SupplierReviews_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierReviews_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierReviews_Retailers_RetailerId",
                        column: x => x.RetailerId,
                        principalTable: "Retailers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Offer_Date", "[EndDate] > [StartDate]");
                    table.CheckConstraint("CK_Offer_Discount", "[DiscountPercentage] > 0 AND [DiscountPercentage] <= 100");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Offers_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_Products_ProductId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_Suppliers_SupplierId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Retailers_CreatedById",
                table: "Retailers",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Retailers_UpdatedById",
                table: "Retailers",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierReviews_CreatedById",
                table: "SupplierReviews",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierReviews_RetailerId",
                table: "SupplierReviews",
                column: "RetailerId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierReviews_SupplierId_RetailerId",
                table: "SupplierReviews",
                columns: new[] { "SupplierId", "RetailerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupplierReviews_UpdatedById",
                table: "SupplierReviews",
                column: "UpdatedById");
